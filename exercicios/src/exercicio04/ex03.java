...
public class ex03 {
	...
	public static void main(String[] args) {
        ...
        System.out.println(produto1.nome + " - " + produto1.precoUnitario);
        System.out.println(produto2.nome + " - " + produto2.precoUnitario);
        System.out.println(produto3.nome + " - " + produto3.precoUnitario);
    }
}
